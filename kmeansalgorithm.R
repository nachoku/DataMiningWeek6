...
It has done less well than the other Algorithms. The accuracy is lower than 90 percent
#TASK: Accuracy = number of correctly classified/(total classified) = 133/150 = 0.896666
#i.e our model has achieved ?% accuracy! 89.7%
